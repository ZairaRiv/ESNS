(function() {
    ...
    function H(a, b, c) {
        var d, e;
        if (Aa(b)) r(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b));
        else if (r(b) && ea(b))
    ...
    function F(a, b) {
        if (va && !ca && b && b.opacity !== q) b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        s(a.style, b)
    }
    ...
    function Ia(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, j = [];
            ...
            if (d) {
                ...
                if (f.length) f = f.join(":"), g = /\.([0-9])/, h = I.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = z.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Ja(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    var q, A = document,
        ...
        Db = K.opera,
        va = /(msie|trident)/i.test(xa) && !Db,
        bb = A.documentMode === 8,
        mb = /AppleWebKit/.test(xa),
        Ga = /Firefox/.test(xa),
        Eb = /(Mobile|Android|Windows Phone)/.test(xa),
        ya = "http://www.w3.org/2000/svg",
        ca = !!A.createElementNS && !!A.createElementNS(ya, "svg").createSVGRect,
        Jb = Ga && parseInt(xa.split("Firefox/")[1], 10) < 4,
        ga = !ca && !va && !!A.createElement("canvas").getContext,
        Ma, Sa, Fb = {},
        nb = 0,
        ab,
        I, Ja, ha, ob, cb, T = function() {
            return q
        },
        W = [],
        Ta = 0,
        ...
        Q = "none",
        Kb = /^[0-9]+$/,
        db = ["plotTop", "marginRight", "marginBottom", "plotLeft"],
        Lb = "stroke-width",
        Fa, ub, ib, vb, wb, xb, yb, jb, kb, zb, Ab, B = {},
        z;
    z = K.Highcharts = K.Highcharts ? ba(16, !0) : {};
    z.seriesTypes = B;
    var s = z.extend = function(a, b) {
            var c;
            a || (a = {});
            for (c in b) a[c] = b[c];
            return a
        ...
        o = z.pick = function() {
            var a = arguments,
                b, c, d = a.length;
            for (b = 0; b < d; b++)
                if (c = a[b], c !== q && c !== null) return c
        },
        da = z.wrap = function(a, b, c) {
            var d = a[b];
            a[b] = function() {
    ...
    z.numberFormat = function(a, b, c, d) {
        var e = I.lang,
            a = +a || 0,
            f = b === -1 ? N((a.toString().split(".")[1] || "").length, 20) : isNaN(b = R(b)) ? 2 : b,
            b = c === void 0 ? e.decimalPoint : c,
            d = d === void 0 ? e.thousandsSep : d,
            e = a < 0 ? "-" : "",
            c = String(D(a = R(a).toFixed(f))),
            g = c.length > 3 ? c.length % 3 : 0;
        return e + (g ? c.substr(0, g) +
            d : "") + c.substr(g).replace(/(\d{3})(?=\d)/g, "$1" + d) + (f ? b + R(a - c).toFixed(f).slice(2) : "")
    };
    ob = {
        init: function(a, b, c) {
            var b = b || "",
        ...
        K.HighchartsAdapter = K.HighchartsAdapter || a && {
            init: function(b) {
                ...
                a.each(["cur", "_default", "width", "height",
                    ...
                    (g = f[e]) && (f[e] = function(a) {
                        var c, a = b ? a : this;
                        if (a.prop !== "align") return c = a.elem, c.attr ? c.attr(a.prop, e === "cur" ? q : a.now) : g.apply(this, arguments)
                    })
                });
                da(a.cssHooks.opacity, "get", function(a, b, c) {
                ...
                a.fn.highcharts = function() {
                    ...
                    if (this[0]) {
                        ...
                        c = b[0];
                        if (c !== q) c.chart = c.chart || {}, c.chart.renderTo = this[0], new z[a](c, b[1]), g = this;
                        c === q && (g = W[H(this[0], "data-highcharts-chart")])
                    }
                    return g
                }
            },
            ...
            fireEvent: function(b, c, d, e) {
                var f = a.Event(c),
                    g = "detached" + c,
                    h;
                !va && d && (delete d.layerX, delete d.layerY, delete d.returnValue);
                s(f, d);
            ...
            washMouseEvent: function(a) {
                ...
                if (c.pageX === q) c.pageX = a.pageX, c.pageY = a.pageY;
                return c
            },
            animate: function(b, c, d) {
                ...
                e.stop();
                c.opacity !== q && b.attr && (c.opacity += "px");
                b.hasAnim = 1;
                e.animate(c, d)
            },
            stop: function(b) {
    ...
    var sa = K.HighchartsAdapter,
        E = sa || {};
    sa && sa.init.call(sa, ob);
    var eb = E.adapterRun,
        Mb = E.getScript,
        Ua = E.inArray,
        m = z.each = E.each,
    ...
    var U = I.plotOptions,
        sa = U.line;
    tb();
    var Pb = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/,
        Qb = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/,
        Rb = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/,
        V = function(a) {
            var b = [],
                c, d;
            (function(a) {
                a && a.stops ? d = Na(a.stops, function(a) {
                    ...
                    D(c[3]), parseFloat(c[4], 10)
                ] : (c = Qb.exec(a)) ? b = [D(c[1], 16), D(c[2], 16), D(c[3], 16), 1] : (c = Rb.exec(a)) && (b = [D(c[1]), D(c[2]), D(c[3]), 1])
            })(a);
            return {
                get: function(c) {
                    var f;
                    d ? (f = u(a), f.stops = [].concat(f.stops), m(d, function(a, b) {
    ...
    P.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                f === "radialGradient" && n && !r(g.gradientUnits) && (g = u(g, {
                    cx: n[0] - n[2] / 2 + g.cx * n[2],
                    cy: n[1] - n[2] / 2 + g.cy * n[2],
                    r: g.r * n[2],
                    gradientUnits: "userSpaceOnUse"
                }));
                for (p in g) p !== "id" && w.push(p, g[p]);
                for (p in j) w.push(j[p]);
                w = w.join(",");
                h[w] ? a = h[w].attr("id") : (g.id = a = "highcharts-" + nb++,
                    h[w] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], m(j, function(a) {
                        a[1].indexOf("rgba") === 0 ? (e = V(a[1]), k = e.get("rgb"), l = e.get("a")) : (k = a[1], l = 1);
        ...
        applyTextShadow: function(a) {
            var b = this.element,
                ...
                e = this.renderer.forExport || b.style.textShadow !== q && !va;
        ...
        attr: function(a, b) {
            var c, d, e = this.element,
                f, g = this,
                h;
            typeof a === "string" && b !== q && (c = a, a = {}, a[c] = b);
            if (typeof a === "string") g = (this[a + "Getter"] || this._defaultGetter).call(this, a, e);
                ...
                for (c in a) {
                    ...
                    this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c) &&
        ...
        on: function(a, b) {
            ...
            Sa && a === "click" ? (d.ontouchstart = function(a) {
                ...
                (xa.indexOf("Android") === -1 || Fa.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a)
            }) : d["on" + a] = b;
            return this
        },
        ...
        align: function(a, b, c) {
            ...
            if (a) {
                if (this.alignOptions =
                    a, this.alignByTranslate = b, !c || Aa(c)) this.alignTo = d = c || "renderer", ua(f, this), f.push(this), c = null
        ...
        getBBox: function(a) {
            ...
            var i, j = f.style,
                k, l;
            d !== q && (l = ["", e || 0, g && g.fontSize, f.style.width].join(","), l = d === "" || Kb.test(d) ? "num:" + d.toString().length + l : d + l);
            l && !a && (b = c.cache[l]);
            if (!b) {
                if (f.namespaceURI === ya || c.forExport) {
                    try {
                        k = this.fakeTS && function(a) {
                            m(f.querySelectorAll(".highcharts-text-shadow"), function(b) {
                                b.style.display = a
                            })
                        }, Ga && j.textShadow ? (i = j.textShadow, j.textShadow =
                            "") : k && k(Q), b = f.getBBox ? s({}, f.getBBox()) : {
                            width: f.offsetWidth,
                ...
                if (c.isSVG) {
                    a = b.width;
                    d = b.height;
                    if (va && g && g.fontSize === "11px" && d.toPrecision(3) === "16.9") b.height = d = 14;
                    if (e) b.width = R(d * na(h)) + R(a * ja(h)), b.height = R(d * ja(h)) + R(a * na(h))
                }
                c.cache[l] = b
            }
            return b
        ...
        show: function(a) {
            a && this.element.namespaceURI === ya ? this.element.removeAttribute("visibility") : this.attr({
        ...
        titleSetter: function(a) {
            ...
            b.textContent = String(o(a), "").replace(/<[^>]*>/g, "")
        },
        ...
        zIndexSetter: function(a, b) {
            ...
            if (e) {
                ...
                for (i = 0; i < d.length && !h; i++)
                    if (e = d[i], f = H(e, "zIndex"), e !== g && (D(f) > a || !r(a) && r(f))) c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
    ...
    P.prototype.translateXSetter = P.prototype.translateYSetter = P.prototype.rotationSetter = P.prototype.verticalAlignSetter =
        P.prototype.scaleXSetter = P.prototype.scaleYSetter = function(a, b) {
            this[b] = a;
            this.doTransform = !0
        };
    ...
    ia.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            g = d.element;
            a.appendChild(g);
            a.innerHTML.indexOf("xmlns") === -1 && H(g, "xmlns", ya);
            this.isSVG = !0;
            this.box = g;
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (Ga || mb) && A.getElementsByTagName("base").length ? f.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
            this.createElement("desc").add().element.appendChild(A.createTextNode("Created with Highmaps 1.1.4"));
            ...
            this.setSize(b, c, !1);
            var h;
            if (Ga && a.getBoundingClientRect) this.subPixelFix = b = function() {
                F(a, {
                    left: 0,
                    top: 0
                });
        ...
        destroy: function() {
            ...
            this.subPixelFix && Y(K, "resize", this.subPixelFix);
        ...
        buildText: function(a) {
            for (var b = a.element, c = this, d = c.forExport, e = o(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = H(b, "x"), k = a.styles, l = a.textWidth,
                    n = k && k.lineHeight, p = k && k.textShadow, w = k && k.textOverflow === "ellipsis", t = g.length, O = l && !a.added && this.box, C = function(a) {
                        return n ? D(n) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12, a).h
                    }, y = function(a) {
                        return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
                    }; t--;) b.removeChild(g[t]);
            !f && !p && !w && e.indexOf(" ") === -1 ? b.appendChild(A.createTextNode(y(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, O && O.appendChild(b), e = f ? e.replace(/<(b|strong)>/g,
                ...
                m(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        var p = {},
                            t = A.createElementNS(ya, "tspan"),
                            m;
                        h.test(e) && (m = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), H(t, "style", m));
                        i.test(e) && !d &&
                            (H(t, "onclick", 'location.href="' + e.match(i)[1] + '"'), F(t, {
                                cursor: "pointer"
                            }));
                        e = y(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            if (l) {
                                for (var p = e.replace(/([^\^])-/g, "$1- ").split(" "), o = g.length > 1 || f || p.length > 1 && k.whiteSpace !== "nowrap", O, q, r, s = [], Oa = C(t), v = 1, x = a.rotation, u = e, B = u.length;
                                    (o || w) && (p.length || s.length);) a.rotation = 0, O = a.getBBox(!0), r =
                                    O.width, !ca && c.forExport && (r = c.measureSpanWidth(t.firstChild.data, a.styles)), O = r > l, q === void 0 && (q = O), w && q ? (B /= 2, u === "" || !O && B < 0.5 ? p = [] : (O && (q = !0), u = e.substring(0, u.length + (O ? -1 : 1) * ra(B)), p = [u + "…"], t.removeChild(t.firstChild))) : !O || p.length === 1 ? (p = s, s = [], p.length && (v++, t = A.createElementNS(ya, "tspan"), H(t, {
                                        dy: Oa,
                                        x: j
                                    }), m && H(t, "style", m), b.appendChild(t)), r > l && (l = r)) : (t.removeChild(t.firstChild), s.unshift(p.pop())), p.length && t.appendChild(A.createTextNode(p.join(" ").replace(/- /g, "-")));
                                q && a.attr("title",
                                    a.textStr);
                                a.rotation = x
                            }
            ...
            }), O && O.removeChild(b), p && a.applyTextShadow && a.applyTextShadow(p))
        },
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            m = h.style;
            delete h.style;
            M(j.element, va ? "mouseover" : "mouseenter", function() {
                k !== 3 && j.attr(f).css(w)
            });
            M(j.element, va ? "mouseout" : "mouseleave", function() {
                k !== 3 && (l = [e, f, g][k], n = [p, w, t][k], j.attr(l).css(n))
            });
            j.setState = function(a) {
                (j.state = k = a) ? a === 2 ? j.attr(g).css(t) : a === 3 && j.attr(h).css(m): j.attr(e).css(p)
            };
        ...
        rect: function(a, b, c, d, e, f) {
            ...
            if (f !== q) a.strokeWidth = f, a = g.crisp(a);
            if (e) a.r = e;
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                var a, b;
                a = w.element.style;
                o = (Pa === void 0 || v === void 0 || p.styles.textAlign) && r(w.textStr) && w.getBBox();
                p.width = (Pa || o.width || 0) + 2 * y + Oa;
                p.height = (v || o.height || 0) + 2 * y;
                D = y + n.fontMetrics(a && a.fontSize, w).b;
                if (E) {
                    if (!t) a = x(-C * y), b = h ? -D : 0, p.box = t = d ? n.symbol(d, a, b, p.width, p.height, G) : n.rect(a, b, p.width,
                        p.height, 0, G[Lb]), t.attr("fill", Q).add(p);
                    t.isImg || t.attr(s({
                        width: x(p.width),
                        height: x(p.height)
                    }, G));
            ...
            function k() {
                var a = p.styles,
                    ...
                    c;
                c = h ? 0 : D;
                if (r(Pa) && o && (a === "center" || a === "right")) b += {
                    center: 0.5,
                    right: 1
                }[a] * (Pa - o.width);
                if (b !== w.x || c !== w.y) w.attr("x", b), c !== q && w.attr(w.element.nodeName === "SPAN" ? "y" : "translateY", c);
                w.x = b;
                w.y = c
            }
            ...
            p.strokeSetter = p.fillSetter = p.rSetter = function(a,
                b) {
                b === "fill" && a && (E = !0);
                l(b, a)
            };
            ...
            return s(p, {
                css: function(a) {
                    if (a) {
                        var b = {},
                            a = u(a);
                        m(p.textProps, function(c) {
                            a[c] !== q && (b[c] = a[c], delete a[c])
                        });
                        w.css(b)
                    }
                    return F.call(p, a)
                ...
                destroy: function() {
                    Y(p.element, "mouseenter");
                    Y(p.element, "mouseleave");
                    w && (w = w.destroy());
                    t && (t = t.destroy());
                    P.prototype.destroy.call(p);
                    p = n = j = k = l = null
                }
            })
        }
    ...
    s(P.prototype, {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    var k = this.rotation,
                        ...
                        p = [k, g, b.innerHTML, this.textWidth].join(",");
                    if (p !== this.cTT) {
        ...
        setSpanRotation: function(a, b, c) {
            var d = {},
                e = va ? "-ms-transform" : mb ? "-webkit-transform" : Ga ? "MozTransform" : Db ? "-o-transform" : "";
            d[e] = d.transform = "rotate(" + a + "deg)";
            d[e + (Ga ? "Origin" : "-origin")] = d.transformOrigin = b * 100 + "% " + c + "px";
            F(this.element, d)
        },
    ...
    if (!ca && !ga) E = {
            ...
            shadow: function(a, b, c) {
                ...
                if (a) {
                    ...
                    for (e = 1; e <= 3; e++) {
                        ...
                        h = $(g.prepVML(j), null, {
                            left: D(i.left) + o(a.offsetX, 1),
                            top: D(i.top) + o(a.offsetY, 1)
                        });
                        if (c) h.cutOff = l + 1;
                        j = ['<stroke color="', a.color || "black", '" opacity="', w * e, '"/>'];
        ...
        E.prototype.xSetter, E = {
            ...
            init: function(a, b, c, d) {
                var e;
                this.alignedObjects = [];
                d = this.createElement(Ea).css(s(this.getStyle(d), {
                    position: "relative"
                }));
                e = d.element;
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    var k, l, n = a.linearGradient || a.radialGradient,
                        ...
                        q, r = [],
                        s = function() {
                            h = ['<fill colors="' + r.join(",") + '" opacity="', t, '" o:opacity2="', w, '" type="', i, '" ', y,
                    ...
                    q[0] < 1 && a.push([1, q[1]]);
                    m(a, function(a, b) {
                        g.test(a[1]) ? (f = V(a[1]), k = f.get("rgb"), l = f.get("a")) : (k = a[1], l = 1);
                        r.push(a[0] * 100 + "% " + k);
                        b ? (t = l, o = k) : (w = l, C = k)
                    });
                    if (c === "fill")
                        if (i === "gradient") c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, p = n.x2 || n[2] || 0, n = n.y2 || n[3] || 0, y = 'angle="' + (90 - J.atan((n - a) / (p - c)) * 180 / lb) + '"', s();
                        else {
                            var j = n.r,
                                v = j * 2,
                                x = j * 2,
                                ...
                                A, j = function() {
                                    z && (A = d.getBBox(),
                                        u += (z[0] - A.x) / A.width - 0.5, B += (z[1] - A.y) / A.height - 0.5, v *= z[2] / A.width, x *= z[2] / A.height);
                                    y = 'src="' + I.global.VMLRadialGradientURL + '" size="' + v + "," + x + '" origin="0.5,0.5" position="' + u + "," + B + '" color2="' + C + '" ';
                                    s()
                                };
                            d.added ? j() : d.onAdd = j;
                            j = o
                ...
                } else if (g.test(a) && b.tagName !== "IMG") f = V(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], $(this.prepVML(h), null, null, b), j = f.get("rgb");
                else {
            ...
            createElement: function(a) {
                return a === "rect" ? this.symbol(a) : ia.prototype.createElement.call(this, a)
            },
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    return ia.prototype.symbols[!r(e) || !e.r ? "square" : "callout"].call(0, a, b, c, d, e)
                }
            }
        }, z.VMLRenderer = Wa = function() {
            this.init.apply(this, arguments)
        }, Wa.prototype = u(ia.prototype, E), Ma = Wa;
    ia.prototype.measureSpanWidth = function(a, b) {
    ...
    var Gb;
    if (ga) z.CanVGRenderer = E = function() {
        ya = "http://www.w3.org/1999/xhtml"
    }, E.prototype.symbols = {}, Gb = function() {
        function a() {
            var a = b.length,
                d;
            for (d = 0; d < a; d++) b[d]();
    ...
    La.prototype = {
        addLabel: function() {
            ...
            b = a.labelFormatter.call({
                ...
                value: a.isLog ? wa(ma(e)) : e
            });
            r(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = r(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(u(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
        },
        ...
        handleOverflow: function(a) {
            var b = this.axis,
                ...
                b = b.slotWidth,
                k;
            if (h) h < 0 && c - i * j < f ? k = x(c / ja(h * ka) - f) : h > 0 && c + i * j > e && (k = x((d - c) / ja(h * ka)));
            else {
                d = c - i * j;
                c += i * j;
                if (d < f) b -= f - d, a.x = f, g.attr({
                    align: "left"
                });
                else if (c > e) b -= c - e, a.x = e, g.attr({
                    align: "right"
                });
                j > b && (k = b)
            }
        ...
        getPosition: function(a, b, c, d) {
            ...
            return {
                x: a ? e.translate(b + c, null, null, d) + e.transB : e.left + e.offset + (e.opposite ?
                    (d && f.oldChartWidth || f.chartWidth) - e.right - e.left : 0),
        ...
        render: function(a, b, c) {
            var d = this.axis,
                ...
                v = !0,
                x = d.tickmarkOffset,
                u = this.getPosition(g, j, x, b),
                B = u.x,
                u = u.y,
                z = g && B === d.pos + d.len || !g && u === d.pos ? -1 : 1,
                c = o(c, 1);
            this.isActive = !0;
            if (w) {
                j =
                    d.getPlotLinePath(j + x, w * z, b, !0);
                if (l === q) {
                    l = {
                        stroke: t,
                        "stroke-width": w
                    ...
                    if (!h) l.zIndex = 1;
                    if (b) l.opacity = 0;
                    this.gridLine = l = w ? f.path(j).attr(l).add(d.gridGroup) : null
                }
            ...
            if (n && C) r === "inside" && (C = -C), d.opposite && (C = -C), h = this.getMarkPath(B, u, C, n * z, g, f), p ? p.animate({
                d: h,
                opacity: c
            ...
            if (i && !isNaN(B)) i.xy = u = this.getLabelPosition(B, u, i, g, k, x, a, s), this.isFirst &&
                !this.isLast && !o(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !o(e.showLastLabel, 1) ? v = !1 : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(u), s && a % s && (v = !1), v && !isNaN(u.y) ? (u.opacity = c, i[this.isNew ? "attr" : "animate"](u), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function() {
            $a(this, this.axis)
        }
    };
    var X = z.Axis = function() {
        this.init.apply(this, arguments)
    };
    X.prototype = {
        defaultOptions: {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: {
                ...
                style: u(U.line.dataLabels.style, {
                    color: "#000000"
                })
            }
        },
        ...
        init: function(a, b) {
            ...
            this.crosshair = o(d.crosshair, qa(a.options.tooltip.crosshairs)[c ? 0 : 1], !1);
            var f, d = this.options.events;
            Ua(this, a.axes) === -1 && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
            this.series = this.series || [];
            if (a.inverted && c && this.reversed === q) this.reversed = !0;
            this.removePlotLine = this.removePlotBand = this.removePlotBandOrLine;
            for (f in d) M(this, f, d[f]);
            if (this.isLog) this.val2lin = Qa, this.lin2val = ma
        },
        setOptions: function(a) {
            this.options =
                u(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], u(I[this.coll], a))
        },
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ia(h, this);
                ...
                for (; f-- && g === q;) c = Math.pow(1E3,
                    f + 1), a >= c && e[f] !== null && (g = z.numberFormat(b / c, -1) + e[f]);
            g === q && (g = R(b) >= 1E4 ? z.numberFormat(b, 0) : z.numberFormat(b, -1, q, ""));
            return g
        },
                ...
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (d = c.xData, d.length) a.dataMin = N(o(a.dataMin,
                            d[0]), Ra(d)), a.dataMax = v(o(a.dataMax, d[0]), Da(d))
                    } else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
                        if (r(c) && r(e)) a.dataMin = N(o(a.dataMin, c), c), a.dataMax = v(o(a.dataMax, e), e);
                        if (r(d))
        ...
        getPlotLinePath: function(a, b, c, d, e) {
            ...
            var p = function(a, b, c) {
                    if (a < b || a > c) d ? a = N(v(b, a), c) : n = !0;
                    return a
                },
                e = o(e, this.translate(a, null, null, c)),
                a = c = x(e + i);
            i = j = x(k - e - i);
            isNaN(e) ? n = !0 : this.horiz ? (i = h, j = k - this.bottom, a = c = p(a, g, g + this.width)) : (a = g, c = l - this.right, i = j = p(i, h, h + this.height));
        ...
        adjustForMinRange: function() {
            var a =
                ...
                f, g, h, i, j;
            if (this.isXAxis && this.minRange === q && !this.isLog) r(a.min) || r(a.max) ? this.minRange = null : (m(this.series, function(a) {
                i = a.xData;
                for (g = j = a.xIncrement ? 1 : i.length - 1; g > 0; g--)
                    if (h = i[g] - i[g - 1], f === q || h < f) f = h
            }), this.minRange = N(f * 5, this.dataMax - this.dataMin));
            ...
            if (k || i || d)
                if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : m(b.series, function(a) {
                        var h = i ? 1 : k ? a.pointRange : b.axisPointRange || 0,
                            ...
                            w = a.closestPointRange;
                        h > c && (h = 0);
                        d = v(d, h);
                        b.single || (f = v(f, Aa(j) ? 0 : h / 2), g = v(g, j === "on" ? 0 : h));
                        !a.noSharedTooltip && r(w) && (e = r(e) ? N(e, w) : w)
                    }), h = b.ordinalSlope &&
                    e ? b.ordinalSlope / e : 1, b.minPointOffset = f *= h, b.pointRangePadding = g *= h, b.pointRange = N(d, c), k) b.closestPointRange = e;
            if (a) b.oldTransA = j;
        ...
        setTickInterval: function(a) {
            ...
            h ? (b.linkedParent = c[b.coll][d.linkedTo],
                c = b.linkedParent.getExtremes(), b.min = o(c.min, c.dataMin), b.max = o(c.max, c.dataMax), d.type !== b.linkedParent.options.type && ba(11, 1)) : (b.min = o(b.userMin, d.min, b.dataMin), b.max = o(b.userMax, d.max, b.dataMax));
            if (e) !a && N(b.min, o(b.dataMin, b.min)) <= 0 && ba(10, 1), b.min = wa(Qa(b.min)), b.max = wa(Qa(b.max));
            if (b.range && r(b.max)) b.userMin = b.min = v(b.min, b.max - b.range), b.userMax = b.max, b.range = null;
            b.beforePadding && b.beforePadding();
            b.adjustForMinRange();
            if (!n && !b.axisPointRange && !b.usePercentage && !h && r(b.min) && r(b.max) &&
                (c = b.max - b.min)) {
            ...
            if (pa(d.ceiling)) b.max = N(b.max, d.ceiling);
            b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : h && !k && l === b.linkedParent.options.tickPixelInterval ? b.linkedParent.tickInterval : o(k, this.tickAmount ? (b.max - b.min) / v(this.tickAmount - 1, 1) : void 0, n ? 1 : (b.max - b.min) * l / v(b.len, l));
            g && !a && m(b.series,
                function(a) {
            ...
            if (!f && !e && !k) b.tickInterval = sb(b.tickInterval, null, J.pow(10, fa(J.log(b.tickInterval) / J.LN10)), o(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
        ...
        setTickPositions: function() {
            ...
            this.tickPositions =
                b = a.tickPositions && a.tickPositions.slice();
            ...
            if (!this.isLinked) this.trimTicks(b, e, f), this.min ===
        ...
        getTickAmount: function() {
            ...
            !d && this.chart.options.chart.alignTicks !==
                !1 && c.alignTicks !== !1 && (m(this.chart[this.coll], function(c) {
                    var d = c.options,
                        c = c.horiz,
        ...
        zoom: function(a, b) {
            var c = this.dataMin,
                d = this.dataMax,
                e = this.options;
            this.allowZoomOutside || (r(c) && a <= N(c, o(e.min, c)) && (a = q), r(d) && b >= v(d, o(e.max, d)) && (b = q));
            this.displayBtn = a !== q || b !== q;
            this.setExtremes(a, b, !1, q, {
                trigger: "zoom"
            });
            return !0
        },
        ...
        getExtremes: function() {
            var a = this.isLog;
            return {
                min: a ? wa(ma(this.min)) : this.min,
                max: a ? wa(ma(this.max)) : this.max,
        ...
        unsquish: function() {
            ...
            c ? (l = r(h) ? [h] : f < 80 && !b.staggerLines && !b.step && b.autoRotation) && m(l, function(a) {
                var b;
                if (a === h || a && a >= -90 && a <= 90) j = n(R(i.h / na(ka * a))), b = j + R(a / 360), b < k && (k = b, g = a, e = j)
            }) : e = n(i.h);
            this.autoRotation = l;
        ...
        renderUnsquish: function() {
            var a = this.chart,
                ...
                f = this.horiz,
                g = a.margin,
                h = this.slotWidth = f && !e.step && !e.rotation && (this.staggerLines || 1) * a.plotWidth / c.length || !f && (g[3] && g[3] - a.spacing[3] || a.chartWidth *
                    0.33),
                i = v(1, x(h - 2 * (e.padding || 5))),
                j = {},
                g = b.fontMetrics(e.style.fontSize, d[0] && d[0].label),
                k, l = 0;
            if (!Aa(e.rotation)) j.rotation = e.rotation;
            if (this.autoRotation) m(c, function(a) {
                ...
                for (h = c.length; !f && h--;)
                    if (i = c[h], (i = d[i].label) && this.len / c.length - 4 < i.getBBox().height) i.specCss = {
                        textOverflow: "ellipsis"
                    }
            }
            j.rotation && (k = {
            ...
            m(c, function(a) {
                var b = (a = d[a]) && a.label;
                if (b) k && b.css(u(k, b.specCss)), delete b.specCss, b.attr(j), a.rotation = j.rotation
            });
                ...
                if (m(e, function(b) {
                    ...
                    m(e, function(b) {
                        if (h === 0 || h === 2 || {
                                1: "left",
                                3: "right"
                            }[h] === a.labelAlign) O = v(f[b].getLabelSize(), O)
                    }), a.staggerLines) O *= a.staggerLines, a.labelOffset = O
            } else
                for (q in f) f[q].destroy(), delete f[q];
            if (w && w.text && w.enabled !== !1) {
                if (!a.axisTitle) a.axisTitle = c.text(w.text, 0, 0, w.useHTML).attr({
                    zIndex: 7,
                ...
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-title").css(w.style).add(a.axisGroup), a.axisTitle.isNew = !0;
                if (k) l =
                    a.axisTitle.getBBox()[g ? "height" : "width"], n = w.offset, p = r(n) ? 0 : o(w.margin, g ? 5 : 10);
                a.axisTitle[k ? "show" : "hide"]()
            }
            a.offset = y * o(d.offset, C[h]);
            a.tickRotCorr = a.tickRotCorr || {
                x: 0,
                y: 0
            };
            c = h === 2 ? a.tickRotCorr.y : 0;
            g = O + p + (O && y * (g ? o(t.y, a.tickRotCorr.y + 8) : t.x) - c);
            a.axisTitleMargin = o(n, g);
            C[h] = v(C[h], a.axisTitleMargin + l + y * a.offset, g);
            b[i] = v(b[i], fa(d.lineWidth / 2) * 2)
        },
        ...
        render: function() {
            var a = this,
                ...
                p = a.tickmarkOffset,
                w = d.lineWidth,
                t, o = b.hasRendered && r(a.oldMin) && !isNaN(a.oldMin);
            t = a.hasData;
            var C = a.showAxis,
                y, s;
            ...
            if (t || f) {
                a.minorTickInterval && !a.categories && m(a.getMinorTickPositions(),
                    function(b) {
                        j[b] || (j[b] = new La(a, b, "minor"));
                        o && j[b].isNew && j[b].render(null, !0);
                        j[b].render(null, !1, 1)
                    });
                if (g.length && (m(g, function(b, c) {
                        if (!f || b >= a.min && b <= a.max) i[b] || (i[b] = new La(a, b)), o && i[b].isNew && i[b].render(c, !0, 0.1), i[b].render(c)
                    }), p && (a.min === 0 || a.single))) i[-1] || (i[-1] = new La(a, -1, null, !0)), i[-1].render(-1);
                n && m(g, function(b, c) {
                    if (c % 2 === 0 && b < a.max) k[b] || (k[b] = new z.PlotLineOrBand(a)), y = b + p, s = g[c + 1] !== q ? g[c + 1] + p : a.max, k[b].options = {
                        from: e ? ma(y) : y,
                        to: e ? ma(s) : s,
                        color: n
            ...
            if (w) t = a.getLinePath(w), a.axisLine ? a.axisLine.animate({
                d: t
        ...
        drawCrosshair: function(a, b) {
            var c, d = this.crosshair,
                e = d.animation;
            if (!this.crosshair || (r(b) || !o(this.crosshair.snap, !0)) === !1) this.hideCrosshair();
            else if (o(d.snap, !0) ? r(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : o(b.stackY,
    ...
    X.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) a = x(a), g = this.getLinearTickPositions(a, b, c);
            ...
            for (var f = fa(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
                i = e.length;
                for (h = 0; h < i && !l; h++) j = Qa(ma(f) * e[h]), j > b && (!d || k <= c) && k !== q && g.push(k), k > c && (l = !0), k = j
            } else if (b = ma(b), c = ma(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval,
                    (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = sb(a, null, J.pow(10, fa(J.log(a) / J.LN10))), g = Na(this.getLinearTickPositions(a, b, c), Qa), !d) this._minorAutoInterval = a / 5;
        if (!d) this.tickInterval = a;
        return g
    };
    var Hb = z.Tooltip = function() {
        this.init.apply(this, arguments)
    };
    Hb.prototype = {
        init: function(a, b) {
        ...
        move: function(a, b, c, d) {
            ...
            s(f, {
                x: g ? (2 * f.x + a) /
                    3 : a,
                y: g ? (f.y + b) / 2 : b,
                anchorX: h ? q : g ? (2 * f.anchorX + c) / 3 : c,
                anchorY: h ? q : g ? (f.anchorY + d) / 2 : d
            });
            e.label.attr(f);
        ...
        hide: function(a) {
            ...
            if (!this.isHidden) c = this.chart.hoverPoints, this.hideTimer = setTimeout(function() {
                b.label.fadeOut();
                b.isHidden = !0
            }, o(a, this.options.hideDelay, 500)), c && m(c, function(a) {
                a.setState()
        ...
        getAnchor: function(a, b) {
            var c, d = this.chart,
                ...
                j, k, a = qa(a);
            c = a[0].tooltipPos;
            this.followPointer && b && (b.chartX === q && (b = d.pointer.normalize(b)), c = [b.chartX - d.plotLeft, b.chartY - f]);
            c || (m(a, function(a) {
                j = a.series.yAxis;
                k = a.series.xAxis;
        ...
        getPosition: function(a,
            ...
            var d = this.chart,
                ...
                j = o(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative),
                k = function(a, b, c, d) {
                    var g = c < d - e,
                        b = d + e + c < b,
                        c = d - e - c;
                ...
                p = function() {
                    k.apply(0, h) !== !1 ? l.apply(0, i) === !1 && !g &&
                        (n(!0), p()) : g ? f.x = f.y = 0 : (n(!0), p())
                };
        ...
        getXDateFormat: function(a, b, c) {
            ...
            if (e) {
                ...
                for (f in cb) {
                    if (e === cb.week && +Ja("%w", a.x) === c.options.startOfWeek && h.substr(6) === "00:00:00.000") {
                        f = "week";
                        break
                    } else if (cb[f] > e) {
                        f = i;
    ...
    var oa;
    Sa = A.documentElement.ontouchstart !== q;
    var za = z.Pointer = function(a, b) {
        this.init(a, b)
    };
    za.prototype = {
        init: function(a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (z.Tooltip && b.tooltip.enabled) a.tooltip = new Hb(a, b.tooltip), this.followTouchMove = o(b.tooltip.followTouchMove, !0);
            this.setDOMEvents()
        },
        normalize: function(a, b) {
            ...
            if (!b) this.chartPosition =
                b = Nb(this.chart.container);
            d.pageX === q ? (c = v(a.x, a.clientX - b.left), d = a.y) : (c = d.pageX - b.left, d = d.pageY - b.top);
            return s(a, {
                chartX: x(c),
                chartY: x(d)
            })
        ...
        runPointActions: function(a) {
            ...
            if (!e && !h)
                for (f =
                    0; f < c.length; f++)
                    if (c[f].directTouch || !c[f].options.stickyTracking) c = [];
            (!h || !h.noSharedTooltip) && (e || !h) ? (m(c, function(b) {
                k = b.noSharedTooltip && e;
                b.visible && !k && o(b.options.enableMouseTracking, !0) && (p = b.searchPoint(a)) && l.push(p)
            }), m(l, function(a) {
                if (a && r(a.plotX) && r(a.plotY) && (a.dist.distX < i || (a.dist.distX === i || a.series.kdDimensions > 1) && a.dist.distR < j)) i = a.dist.distX, j = a.dist.distR, n = a
            ...
            if (n && (n !== g || d && d.isHidden)) {
                ...
                n.onMouseOver(a)
            } else f = h && h.tooltipOptions.followPointer, d && f && !d.isHidden && (f = d.getAnchor([{}], a), d.updatePosition({
                plotX: f[0],
                plotY: f[1]
            }));
            if (d && !this._onDocumentMouseMove) this._onDocumentMouseMove = function(a) {
                if (W[oa]) W[oa].pointer.onDocumentMouseMove(a)
            }, M(A, "mousemove", this._onDocumentMouseMove);
            m(b.axes, function(b) {
                b.drawCrosshair(a, o(n, g))
            })
        },
        reset: function(a, b) {
            var c = this.chart,
            ...
            (a = a && f && g) && qa(g)[0].plotX === q && (a = !1);
            if (a) f.refresh(g), e && (e.setState(e.state, !0), m(c.axes, function(b) {
                o(b.options.crosshair && b.options.crosshair.snap, !0) ? b.drawCrosshair(null, a) : b.hideCrosshair()
            }));
            else {
                if (e) e.onMouseOut();
                if (d) d.onMouseOut();
                f && f.hide(b);
                if (this._onDocumentMouseMove) Y(A, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove =
                    null;
                m(c.axes, function(a) {
                    a.hideCrosshair()
                });
        ...
        drag: function(a) {
            ...
            if (this.hasDragged > 10) {
                ...
                if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !m && !this.selectionMarker) this.selectionMarker = b.renderer.rect(h, i,
                    f ? 1 : j, g ? 1 : k, 0).attr({
        ...
        onContainerClick: function(a) {
            ...
            a.originalEvent = a;
            a.cancelBubble = !0;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (L(c.series, "click", s(a, {
                point: c
            })), b.hoverPoint && c.firePointEvent("click",
                a)) : (s(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && L(b, "click", a)))
        },
        setDOMEvents: function() {
            ...
            Ta === 1 && M(A, "mouseup", a.onDocumentMouseUp);
            if (Sa) b.ontouchstart = function(b) {
                    a.onContainerTouchStart(b)
                }, b.ontouchmove = function(b) {
                    a.onContainerTouchMove(b)
                }, Ta === 1 &&
                M(A, "touchend", a.onDocumentTouchEnd)
        },
        destroy: function() {
            var a;
            Y(this.chart.container, "mouseleave", this.onContainerMouseLeave);
            Ta || (Y(A, "mouseup", this.onDocumentMouseUp), Y(A, "touchend", this.onDocumentTouchEnd));
    ...
    s(z.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a,
            ...
            var i = this.chart,
                ...
                u = !q && c[1][l],
                x, c = function() {
                    !q && R(s - v) > 20 && (O = h || R(r - u) / R(s - v));
                    o = (p - r) / O + s;
                    m = i["plot" + (a ? "Width" : "Height")] / O
                };
            c();
            b = o;
            b < y.min ? (b = y.min, x = !0) : b + m > y.max && (b = y.max - m, x = !0);
            x ? (r -= 0.8 * (r - g[j][0]), q || (u -= 0.8 * (u - g[j][1])), c()) : g[j] = [r, u];
            C || (f[j] = o - p, f[n] = m);
            f = C ? 1 / O : O;
            e[n] = m;
            e[j] = b;
        ...
        pinch: function(a) {
            ...
            }), g.x = [d[0].chartX, d[1] && d[1].chartX], g.y = [d[0].chartY, d[1] && d[1].chartY], m(c.axes,
                function(a) {
                    if (a.zoomEnabled) {
    ...
    if (K.PointerEvent || K.MSPointerEvent) {
        var ta = {},
            ...
            Sb = function() {
                ...
                for (a in ta) ta.hasOwnProperty(a) && b.push({
                    pageX: ta[a].pageX,
                    pageY: ta[a].pageY,
                    target: ta[a].target
                });
            ...
            rb = function(a, b, c, d) {
                a = a.originalEvent || a;
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && W[oa]) d(a), d = W[oa].pointer, d[b]({
                    type: c,
        ...
        s(za.prototype, {
            ...
            batchMSEvents: function(a) {
                ...
                a(A, qb ? "pointerup" : "MSPointerUp", this.onDocumentPointerUp)
            }
        });
        da(za.prototype, "init", function(a, b, c) {
            a.call(this, b, c);
            (this.hasZoom || this.followTouchMove) && F(b.container, {
                "-ms-touch-action": Q,
                "touch-action": Q
            })
        });
        da(za.prototype, "setDOMEvents", function(a) {
            a.apply(this);
            (this.hasZoom || this.followTouchMove) && this.batchMSEvents(M)
        });
        da(za.prototype, "destroy", function(a) {
            this.batchMSEvents(Y);
            a.call(this)
        })
    }
    var Xa = z.Legend = function(a, b) {
        this.init(a, b)
    };
    Xa.prototype = {
        init: function(a, b) {
            ...
            if (b.enabled) c.itemStyle =
                d, c.itemHiddenStyle = u(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = o(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = o(b.symbolWidth, 16), c.pages = [], c.render(), M(c.chart, "endResize", function() {
        ...
        colorizeItem: function(a, b) {
            ...
            if (f) {
                if (g && f.isMarker)
                    for (j in i.stroke = h, g = a.convertAttribs(g), g) d = g[j], d !== q && (i[j] = d);
                f.attr(i)
            }
        },
        ...
        renderItem: function(a) {
            var b = this.chart,
                ...
                t = this.initialItemX,
                q = a.legendItem,
                C = a.series && a.series.drawLegendSymbol ? a.series : a,
                y = C.options,
            ...
            if (!q) {
                ...
                a.legendItem = q = c.text(d.labelFormat ? Ia(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline || 0, s).css(u(a.visible ? h : i)).attr({
                    align: l ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup);
                if (!this.baseline) this.baseline = c.fontMetrics(h.fontSize, q).f + 3 + m, q.attr("y", this.baseline);
            ...
            c = q.getBBox();
            f = a.checkboxOffset = d.itemWidth || a.legendItemWidth || f + g + c.width + k + (y ? 20 : 0);
            this.itemHeight = g = x(a.legendItemHeight || c.height);
            if (e && this.itemX - t + f > (n || b.chartWidth - 2 * j - t - d.x)) this.itemX = t, this.itemY += m + this.lastLineHeight + p;
            this.maxItemWidth = v(this.maxItemWidth,
                f);
            this.lastItemY = m + this.itemY + p;
            this.lastLineHeight = v(g, this.lastLineHeight);
            a._legendItemPos = [this.itemX, this.itemY];
            e ? this.itemX += f : (this.itemY += m + g + p, this.lastLineHeight = g);
            this.offsetWidth = n || v((e ? this.itemX - t - k : f) + j, this.offsetWidth)
        },
        getAllItems: function() {
            var a = [];
            m(this.chart.series, function(b) {
                var c = b.options;
                if (o(c.showInLegend, !r(c.linkedTo) ? q : !1, !0)) a = a.concat(b.legendItems || (c.legendType === "point" ? b.data : b))
            });
            return a
        },
        adjustMargins: function(a, b) {
            ...
            this.display && !d.floating && m([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(f, g) {
                f.test(e) && !r(a[g]) && (c[db[g]] = v(c[db[g]], c.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][g] * d[g % 2 ? "x" : "y"] + o(d.margin, 12) + b[g]))
            })
        },
        render: function() {
            var a = this,
        ...
        handleOverflow: function(a) {
            var b = this,
                ...
                e = this.options,
                f = e.y,
                f = c.spacingBox.height + (e.verticalAlign ===
                    "top" ? -f : f) - this.padding,
                g = e.maxHeight,
                h, i = this.clipRect,
                j = e.navigation,
                k = o(j.animation, !0),
            ...
            if (a > f && !e.useHTML) {
                ...
                m(t, function(a, b) {
                    var c = a._legendItemPos[1],
                        ...
                        e = p.length;
                    if (!e || c - p[e - 1] > h && (w || c) !== p[e - 1]) p.push(w || c), e++;
                    b === t.length - 1 &&
                        c + d - p[e - 1] > h && p.push(c);
                    c !== w && (w = c)
                });
        ...
        scroll: function(a, b) {
            var c = this.pages,
                ...
                j = this.padding;
            e > d && (e = d);
            if (e > 0) b !== q && (ha = o(b, this.chart.animation)), this.nav.attr({
                translateX: j,
    ...
    (/Trident\/7\.0/.test(xa) || Ga) && da(Xa.prototype, "positionItem", function(a, b) {
        var c = this,
            d = function() {
    ...
    la.prototype = {
        ...
        init: function(a, b) {
            ...
            f.xAxis = [];
            f.yAxis = [];
            f.animation = ga ? !1 : o(d.animation, !0);
            f.pointCount = f.colorCounter = f.symbolCounter = 0;
            f.firstRender()
        },
        initSeries: function(a) {
            var b = this.options.chart;
            (b = B[a.type || b.type || b.defaultSeriesType]) || ba(17, !0);
            b = new b;
            b.init(this, a);
            return b
        },
        ...
        redraw: function(a) {
            ...
            i &&
                (m(b, function(a) {
                    ...
                    if (a.isDirtyExtremes) a.isDirtyExtremes = !1, w.push(function() {
                        L(a, "afterSetExtremes", s(a.eventArgs, a.getExtremes()));
                        delete a.eventArgs
                    });
                    (j || g) && a.redraw()
                }));
        ...
        setTitle: function(a, b, c) {
            ...
            var d = this,
                e = d.options,
                f;
            f = e.title = u(e.title, a);
            g = e.subtitle = u(e.subtitle, b), e = g;
            m([
                ["title", a, f],
                ["subtitle", b, e]
            ], function(a) {
        ...
        getChartSize: function() {
            ...
            if (!r(b)) this.containerWidth = eb(c, "width");
            if (!r(a)) this.containerHeight =
                eb(c, "height");
        ...
        cloneRenderTo: function(a) {
            ...
            a ? b && (this.renderTo.appendChild(c), Ka(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), F(b, {
                ...
                "important"), A.body.appendChild(b), c && b.appendChild(c))
        },
        getContainer: function() {
            ...
            e = "highcharts-" + nb++;
            if (Aa(a)) this.renderTo = a = A.getElementById(a);
            a || ba(13, !0);
            c = D(H(a, "data-highcharts-chart"));
            ...
            this.renderer = b.forExport ? new ia(a, c, d, b.style, !0) : new Ma(a, c, d, b.style);
        ...
        reflow: function(a) {
            var b = this,
                ...
                d =
                b.renderTo,
                e = c.width || eb(d, "width"),
                f = c.height || eb(d, "height"),
                c = a ? a.target : K,
                d = function() {
                    if (b.container) b.setSize(e, f, !1), b.hasUserSize = null
                };
            if (!b.hasUserSize && !b.isPrinting && e && f && (c === K || c === A)) {
        ...
        drawChartBox: function() {
            ...
            if (k) f ? f.animate(y) : this.plotBackground = b.rect(m, o, q, C, 0).attr({
                fill: k
            }).add().shadow(a.plotShadow);
            if (l) h ? h.animate(y) : this.plotBGImage = b.image(l, m, o, q, C).add();
            s ? s.animate({
                width: r.width,
                height: r.height
        ...
        linkSeries: function() {
            ...
            m(b, function(b) {
                ...
                if (Aa(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d))) d.linkedSeries.push(b), b.linkedParent = d
            })
        },
        ...
        destroy: function() {
            ...
            if (d) d.innerHTML = "", Y(d), f && Ka(d);
            for (e in a) delete a[e]
        },
        isReadyToRender: function() {
            var a = this;
            return !ca && K == K.top && A.readyState !== "complete" || ga && !K.canvg ? (ga ? Gb.push(function() {
                    a.firstRender()
        ...
        firstRender: function() {
            ...
            if (a.isReadyToRender()) {
                ...
                a.linkSeries();
                L(a, "beforeRender");
                if (z.Pointer) a.pointer = new za(a, b);
                a.render();
                a.renderer.draw();
                c && c.apply(a, [a]);
                m(a.callbacks,
                    function(b) {
                        a.index !== q && b.apply(a, [a])
                    });
                L(a, "load");
                a.cloneRenderTo(!0)
            }
    ...
    Z.prototype = {
        ...
        applyOptions: function(a, b) {
            ...
            if (d) this.y = this[d];
            if (this.x === q && c) this.x = b === q ? c.autoIncrement() : b;
            return this
        },
    ...
    S.prototype = {
        ...
        bindAxes: function() {
            ...
            m(a.axisTypes || [], function(e) {
                m(c[e], function(c) {
                    d = c.options;
                    if (b[e] === d.index || b[e] !== q && b[e] === d.id || b[e] === q && d.index === 0) c.series.push(a),
                        a[e] = c, c.isDirty = !0
                });
        ...
        autoIncrement: function() {
            ...
            if (d === "month" ||
                d === "year") a = new Fa(b), a = d === "month" ? +a[zb](a[jb]() + c) : +a[Ab](a[kb]() + c), c = a - b;
            this.xIncrement = b + c;
            return b
        },
        ...
        setOptions: function(a) {
            ...
            this.userOptions = a;
            c = u(e, c.series, a);
            this.tooltipOptions = u(I.tooltip, I.plotOptions[this.type].tooltip, b.tooltip, d.series && d.series.tooltip, d[this.type] && d[this.type].tooltip, a.tooltip);
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) m(a, function(a, b) {
                ...
                if (p && h > p) {
                    ...
                    if (pa(k)) {
                        ...
                        for (c = 0; c < h; c++) w[c] = n, t[c] = a[c], n += i;
                        e.xIncrement = n
                    } else if (Ba(k))
                        if (s)
                            for (c = 0; c < h; c++) i = a[c], w[c] = i[0], t[c] = i.slice(1, s + 1);
                        else
                            for (c = 0; c < h; c++) i = a[c], w[c] = i[0], t[c] = i[1];
                    else ba(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== q && (i = {
        ...
        processData: function(a) {
            ...
            if (k && this.sorted && (!i || d > i || this.forceCrop))
                ...
                else if (b[0] < l || b[d - 1] > n) e = this.cropData(this.xData, this.yData, l, n), b = e.xData,
                c = e.yData, e = e.start, f = !0;
            for (i = b.length - 1; i >= 0; i--) d = b[i] - b[i - 1], d > 0 && (g === q || d < g) ? g = d : d < 0 && this.requireSorting && ba(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        generatePoints: function() {
            ...
            for (n = 0; n < g; n++) i = h + n, j ? l[n] = (new f).init(this, [d[n]].concat(qa(e[n]))) : (b[i] ? k = b[i] : a[i] !== q && (b[i] = k = (new f).init(this, a[i], d[n])), l[n] = k), l[n].index = i;
            if (b && (g !== (c = b.length) || j))
                for (n = 0; n < c; n++)
                    if (n === h && !j && (n += g), b[n]) b[n].destroyElements(), b[n].plotX = q;
            this.data = b;
            this.points = l
        },
        getExtremes: function(a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)
                if (j = c[l], k = a[l], i = k !== null && k !== q && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j)
                    if (i = k.length)
                        for (; i--;) k[i] !== null && (e[f++] = k[i]);
                    else e[f++] = k;
            this.dataMin = o(void 0, Ra(e));
            this.dataMax = o(void 0, Da(e))
        },
        translate: function() {
            this.processedXData || this.processData();
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || pa(i), k = a.threshold, l, n, p, m = Number.MAX_VALUE, a = 0; a < g; a++) {
                var t = f[a],
                    s = t.x,
                    C = t.y;
                n = t.low;
                var y = b && e.stacks[(this.negStacks && C < k ? "-" : "") + this.stackKey];
                if (e.isLog && C !== null && C <= 0) t.y = C = null, ba(10);
                t.plotX = l = c.translate(s, 0, 0, 0, 1, i, this.type === "flags");
                if (b && this.visible && y && y[s]) y = y[s], C = y.points[this.index + "," + a], n = C[0], C = C[1], n === 0 && (n = o(k,
                    e.min)), e.isLog && n <= 0 && (n = null), t.total = t.stackTotal = y.total, t.percentage = y.total && t.y / y.total * 100, t.stackY = C, y.setOffset(this.pointXOffset || 0, this.barW || 0);
                t.yBottom = r(n) ? e.translate(n, 0, 1, 0, 1) : null;
                h && (C = this.modifyValue(C, t));
                t.plotY = n = typeof C === "number" && C !== Infinity ? N(v(-1E5, e.translate(C, 0, 1, 0, 1)), 1E5) : q;
                t.isInside = n !== q && n >= 0 && n <= e.len && l >= 0 && l <= c.len;
                t.clientX = j ? c.translate(s, 0, 0, 0, 1) : l;
                t.negative = t.y < (k || 0);
                t.category = d && d[t.x] !== q ? d[t.x] : t.x;
                a && (m = N(m, R(l - p)));
                p = l
            }
        ...
        setClip: function(a) {
            ...
            a || (h.count -= 1, h.count <= 0 && g && b[g] &&
                (e || (b[g] = b[g].destroy()), b[g + "m"] && (b[g + "m"] = b[g + "m"].destroy())))
        },
        animate: function(a) {
            var b = this.chart,
                c = this.options.animation,
                d;
            if (c && !ea(c)) c = U[this.type].animation;
        ...
        drawPoints: function() {
            var a, b = this.points,
                ...
                n = this.pointAttr[""],
                p, m, t, r = this.markerGroup,
                C = o(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = fa(g.plotX), e = g.plotY, k = g.graphic, p = g.marker || {}, m = !!g.marker, a = C && p.enabled === q || p.enabled, t = g.isInside, a && e !== q && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || n, h = a.r, i = o(p.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[t ? "show" : "hide"](!0).animate(s({
                            x: d - h,
                            y: e - h
                        }, k.symbolName ? {
                            width: 2 * h,
                            ...
                            if (t &&
                                (h > 0 || j)) g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, m ? p : l).attr(a).add(r)
                        }
        ...
        getAttribs: function() {
            ...
            var t = a.zones,
                q = a.zoneAxis || "y",
                C;
            b.marker ? (e.radius = e.radius || c.radius + e.radiusPlus, e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : (e.color = e.color || V(e.color || g).brighten(e.brightness).get(), e.negativeColor = e.negativeColor || V(e.negativeColor || h).brighten(e.brightness).get());
            ...
            if (!j || g < j || l)
                for (; g--;) {
                    ...
                    if (t.length) {
                        l = 0;
                        for (f = t[l]; j[q] >= f.value;) f = t[++l];
                        j.color = j.fillColor = f.color
                    }
                    l = b.colorByPoint || j.color;
                    if (j.options)
                        for (C in n) r(c[n[C]]) && (l = !0);
                    if (l) {
                        c = c || {};
                        l = [];
                        d = c.states || {};
                        f = d.hover = d.hover || {};
                        if (!b.marker) f.color = f.color || !j.options.color && e[j.negative && h ? "negativeColor" : "color"] || V(j.color).brighten(f.brightness || e.brightness).get();
                        f = {
                            color: j.color
                        };
                        if (!o) f.fillColor = j.color;
                        if (!p) f.lineColor = j.color;
                        l[""] = a.convertAttribs(s(f,
                            c), k[""]);
        ...
        destroy: function() {
            ...
            m("area,graph,dataLabelsGroup,group,markerGroup,tracker,graphNeg,areaNeg,posClip,negClip".split(","),
                function(b) {
        ...
        applyZones: function() {
            ...
            if (d.length && (i || j)) i.hide(), j && j.hide(), m(d, function(d, i) {
                e = o(f, n ? p ? b.plotWidth :
                    0 : p ? 0 : l.toPixels(l.min));
                f = x(l.toPixels(o(d.value, l.max), !0));
                w && (e = f = l.toPixels(l.max));
                if (l.isXAxis) {
                    if (h = {
                            x: n ? f : e,
                            y: 0,
                            width: Math.abs(e - f),
                            height: k
                        }, !p) h.x = b.plotHeight - h.x
                } else if (h = {
                        x: 0,
                        y: n ? e : f,
                        width: k,
                        height: Math.abs(e - f)
                    }, p) h.y = b.plotWidth - h.y;
        ...
        redraw: function() {
            ...
            d && (a.inverted && d.attr({
                ...
                translateX: o(e && e.left, a.plotLeft),
                translateY: o(f && f.top, a.plotTop)
            }));
            this.translate();
            this.render();
        ...
        searchPoint: function(a) {
            ...
            a.plotY =
                d ? c.len - a.chartX + c.pos : a.chartY - c.pos;
        ...
        searchKDTree: function(a) {
            function b(a, h, i, j) {
                ...
                var m = r(a[f]) && r(k[f]) ? Math.pow(a[f] - k[f], 2) : null,
                    o = (n || 0) + (m || 0);
                n = {
                    distX: r(n) ? Math.sqrt(n) : Number.MAX_VALUE,
                    distY: r(m) ? Math.sqrt(m) : Number.MAX_VALUE,
                    distR: r(o) ? Math.sqrt(o) : Number.MAX_VALUE
                };
                k.dist = n;
                l = a[l] - k[l];
                n = l < 0 ? "left" : "right";
                h[n] && (n = b(a, h[n], i + 1, j), p = n.dist[d] < p.dist[d] ? n : k, k = l < 0 ? "right" : "left", h[k] && Math.sqrt(l * l) < p.dist[d] && (a = b(a, h[k], i + 1, j), p = a.dist[d] < p.dist[d] ? a : p));
                return p
            }
            var c = this,
                d = this.kdComparer,
    ...
    s(la.prototype, {
        ...
        showLoading: function(a) {
            ...
            if (!d) b.loadingDiv = d = $(Ea, {
                className: "highcharts-loading"
            }, s(e.style, {
                zIndex: 10,
                display: Q
            }), b.container), b.loadingSpan = $("span", null, e.labelStyle, d), M(b, "redraw", f);
    ...
    s(Z.prototype, {
        update: function(a, b, c, d) {
            function e() {
                f.applyOptions(a);
                if (ea(a) && !Ba(a)) f.redraw = function() {
    ...
    s(S.prototype, {
        ...
        remove: function(a, b) {
            var c = this,
                d = c.chart,
                a = o(a, !0);
            if (!c.isRemoving) c.isRemoving = !0, L(c, "remove", null, function() {
                c.destroy();
    ...
    s(X.prototype, {
        update: function(a, b) {
            var c = this.chart,
                a = c.options[this.coll][this.options.index] = u(this.userOptions, a);
            this.destroy(!0);
            this._addedPlotLB = q;
            this.init(c, s(a, {
                events: q
        ...
        remove: function(a) {
            for (var b = this.chart,
                    c = this.coll, d = this.series, e = d.length; e--;) d[e] && d[e].remove(!1);
            ua(b.axes, this);
            ua(b[c], this);
    ...
    E = aa(S, {
        ...
        getColumnMetrics: function() {
            ...
            b.grouping === !1 ? i = 1 : m(a.chart.series, function(b) {
                var c = b.options,
                    e = b.yAxis;
                if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos) c.stacking ? (f = b.stackKey, g[f] === q && (g[f] = i++), h = g[f]) : c.grouping !== !1 && (h = i++), b.columnIndex = h
            });
            var c = N(R(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                j = c * b.groupPadding,
                k = (c - 2 * j) / i,
                l = b.pointWidth,
                b = r(l) ?
                (k - l) / 2 : k * b.pointPadding,
                l = o(l, k - 2 * b);
        ...
        translate: function() {
            ...
            m(a.points, function(c) {
                var d = o(c.yBottom, f),
                    h = N(v(-999 - d, c.plotY), e.len + 999 + d),
                    m = c.plotX + k,
                    q = j,
                    s = N(h, d),
                    r;
                r = v(h, d) - s;
                R(r) < g && g && (r = g, s = x(R(s - f) > g ? d - g : f - (e.translate(c.y, 0, 1, 0, 1) <= f ? g : 0)));
                c.barX = m;
                c.pointWidth = i;
                c.tooltipPos = b.inverted ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - m - q / 2] : [m + q / 2, h + e.pos - b.plotTop];
                q = x(m + q) + l;
                m = x(m) + l;
                q -= m;
                d = R(s) < 0.5;
        ...
        drawPoints: function() {
            ...
            m(a.points, function(h) {
                var i = h.plotY,
                    j = h.graphic;
                if (i !== q && !isNaN(i) && h.y !== null) f = h.shapeArgs, i = r(a.borderWidth) ? {
                    "stroke-width": a.borderWidth
                } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (Va(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](u(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking &&
                    !c.borderRadius);
        ...
        animate: function(a) {
            var b = this.yAxis,
                ...
                d = this.chart.inverted,
                e = {};
            if (ca) a ? (e.scaleY = 0.001, a = N(b.pos + b.len, v(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        },
        remove: function() {
            var a = this,
                b = a.chart;
    ...
    S.prototype.drawDataLabels = function() {
        ...
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), o(d.defer, !0) && (j.attr({
            opacity: +h
            ...
            if (m && !h) e.dataLabel = m.destroy();
                ...
                h = d.rotation;
                w = e.getLabelConfig();
                i = d.format ? Ia(d.format, w) : d.formatter.call(w, d);
                y.color = o(d.color, y.color, a.color, "black");
                if (m)
                    if (r(i)) m.attr({
                        text: i
                    }), C = !1;
                    else {
                        if (e.dataLabel = m = m.destroy(), v) e.connector = v.destroy()
                    }
                else if (r(i)) {
                    m = {
                    ...
                    if (y.color === "contrast") x.color = d.inside || d.distance < 0 || b.stacking ? k.getContrast(e.color || a.color) : "#000000";
                    if (c) x.cursor = c;
                    for (t in m) m[t] === q && delete m[t];
                    m = e.dataLabel = k[h ? "text" : "label"](i, 0, -999, d.shape, null, null, d.useHTML).attr(m).css(s(y, x)).add(j).shadow(d.shadow)
                }
                m && a.alignDataLabel(e, m, d, null, C)
            }
        })
    };
    S.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (l) d = s({
            ...
            align: c.align
        })) : (b.align(c, null, d), g = b.alignAttr, o(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : o(c.crop, !0) && (l = f.isInsidePlot(g.x, g.y) &&
    ...
    if (B.pie) B.pie.prototype.drawDataLabels = function() {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (E = 2; E--;) {
                ...
                if (K) {
                    ...
                    for (G = b = 0; !b && I[G];) b = I[G] && I[G].dataLabel && (I[G].dataLabel.getBBox().height || 21), G++;
                    if (n > 0) {
                        y = N(t + q + n, d.plotHeight);
                        for (G = v(0, t - q - n); G <= y; G += b) J.push(G);
                        y = J.length;
                        if (K > y) {
                            c = [].concat(I);
                            c.sort(L);
                            for (G = K; G--;) c[G].rank = G;
                            for (G = K; G--;) I[G].rank >= y && I.splice(G, 1);
                            K = I.length
                        }
                        for (G = 0; G < K; G++) {
                            c = I[G];
                            ...
                            c = 9999;
                            var Q, P;
                            for (P = 0; P < y; P++) Q = R(J[P] - u[1]), Q < c && (c = Q, H = P);
                            if (H < G && J[G] !== null) H =
                                G;
                            else
                                for (y < K - G + H && J[G] !== null && (H = y - K + G); J[H] === null;) H++;
                            M.push({
                                i: H,
                                y: J[H]
                            });
                    ...
                    for (G = 0; G < K; G++) {
                        ...
                        c = u[1];
                        if (n > 0) {
                            if (y = M.pop(), H = y.i, A = y.y, c > A && J[H + 1] !== null || c < A && J[H - 1] !== null) A = N(v(0, c), d.plotHeight)
                        } else A = c;
                        z = e.justify ? p[0] + (E ? -1 : 1) * (q + n) : a.getX(A === t - q - n || A === t + q + n ? c : A, E);
                        r._attr = {
                            visibility: D,
                            align: u[6]
                        };
                        ...
                        if (this.options.size ===
                            null) y = r.width, z - y < f ? F[3] = v(x(y - z + f), F[3]) : z + y > h - f && (F[1] = v(x(z + y - h + f), F[1])), A - b / 2 < 0 ? F[0] = v(x(-A + b / 2), F[0]) : A + b / 2 > i && (F[2] = v(x(A + b / 2 - i), F[2]))
                    }
                }
            }
            if (Da(F) === 0 || this.verifyDataLabelOverflow(F)) this.placeDataLabels(), s && g && m(this.points, function(b) {
                j = b.connector;
                u = b.labelPos;
                if ((r = b.dataLabel) && r._pos) D = r._attr.visibility, z = r.connX, A = r.connY, k = l ? ["M", z + (u[6] === "left" ? 5 : -5), A, "C", z, A, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", z + (u[6] === "left" ? 5 : -5), A, "L", u[2], u[3], "L", u[4], u[5]], j ? (j.animate({
                        d: k
                    }),
    ...
    }, B.pie.prototype.alignDataLabel = T, B.pie.prototype.verifyDataLabelOverflow = function(a) {
        var b = this.center,
            c = this.options,
            d = c.center,
            e = c = c.minSize || 80,
        ...
        d[1] !== null ? e = v(N(e, b[2] - v(a[0], a[2])), c) : (e = v(N(e, b[2] - a[0] - a[2]), c), b[1] += (a[0] - a[2]) / 2);
    ...
    if (B.column) B.column.prototype.alignDataLabel = function(a, b, c, d, e) {
        var f = this.chart.inverted,
            ...
            i = a.below || a.plotY >
            o(this.translatedThreshold, g.yAxis.len),
    ...
    da(X.prototype, "getSeriesExtremes", function(a) {
        var b = this.isXAxis,
            c, d, e = [],
            f;
        b && m(this.series, function(a, b) {
            if (a.useMapGeometry) e[b] =
                a.xData, a.xData = []
        });
        a.call(this);
        if (b && (c = o(this.dataMin, Number.MAX_VALUE), d = o(this.dataMax, -Number.MAX_VALUE), m(this.series, function(a, b) {
    ...
    da(X.prototype, "setAxisTranslation", function(a) {
        var b = this.chart,
            ...
            d = b.xAxis[0];
        a.call(this);
        if (b.options.chart.preserveAspectRatio && this.coll === "yAxis" && d.transA !== q && (this.transA = d.transA = Math.min(this.transA,
    ...
    da(X.prototype, "render", function(a) {
        a.call(this);
        this.fixTo = null
    });
    var Za = z.ColorAxis = function() {
        this.isColorAxis = !0;
        this.init.apply(this, arguments)
    };
    s(Za.prototype, X.prototype);
    s(Za.prototype, {
        ...
        init: function(a, b) {
            var c = a.options.legend.layout !== "vertical",
                d;
            d = u(this.defaultColorAxisOptions, {
                side: c ? 2 : 1,
                reversed: !c
            }, b, {
                isX: c,
        ...
        tweenColors: function(a, b, c) {
            var d;
            !b.rgba.length || !a.rgba.length ? (z.error(23), a = b.raw) : (a = a.rgba, b = b.rgba, d = b[3] !== 1 || a[3] !== 1, a = (d ? "rgba(" : "rgb(") + Math.round(b[0] + (a[0] - b[0]) * (1 - c)) + "," + Math.round(b[1] + (a[1] - b[1]) * (1 - c)) + "," + Math.round(b[2] + (a[2] - b[2]) * (1 - c)) + (d ? "," + (b[3] + (a[3] - b[3]) * (1 - c)) : "") + ")");
            return a
        },
        initDataClasses: function(a) {
            ...
            this.dataClasses = d = [];
            this.legendItems = [];
            m(a.dataClasses, function(a, i) {
                var j,
                    a = u(a);
                d.push(a);
                if (!a.color) f.dataClassColor === "category" ? (j = c.options.colors, a.color = j[e++], e === j.length && (e = 0)) : a.color = b.tweenColors(V(f.minColor), V(f.maxColor), g < 2 ? 0.5 : i / (g - 1))
            })
        },
        ...
        toColor: function(a, b) {
            ...
            if (f)
                for (h = f.length; h--;) {
                    if (g = f[h], e = g.from, d = g.to, (e === q || a >= e) && (d === q || a <= d)) {
                        c = g.color;
                        if (b) b.dataClass = h;
                        break
                    }
        ...
        drawCrosshair: function(a, b) {
            var c = b && b.plotX,
                ...
                e, f = this.pos,
                g = this.len;
            if (b) e = this.toPixels(b[b.series.colorKey]), e < f ? e = f - 2 : e > f + g && (e = f + g + 2), b.plotX = e, b.plotY = this.len - e, X.prototype.drawCrosshair.call(this, a, b), b.plotX = c, b.plotY = d, this.cross && this.cross.attr({
                fill: this.crosshair.color
            }).add(this.legendGroup)
        },
        getPlotLinePath: function(a,
            b, c, d, e) {
            return e ? this.horiz ? ["M", e - 4, this.top - 6, "L", e + 4, this.top - 6, e, this.top, "Z"] : ["M", this.left, e, "L", this.left - 6, e + 6, this.left - 6, e - 6, "Z"] : X.prototype.getPlotLinePath.call(this, a, b, c, d)
        },
        update: function(a, b) {
            m(this.series, function(a) {
                a.isDirtyData = !0
        ...
        getDataClassLegendSymbols: function() {
            var a = this,
                ...
                "",
                g;
            c.length || m(this.dataClasses, function(d, i) {
                var j = !0,
                    k = d.from,
                    l = d.to;
                g = "";
                k === q ? g = "< " : l === q && (g = "> ");
                k !== q && (g += z.numberFormat(k, e) + f);
                k !== q && l !== q && (g += " - ");
                l !== q && (g += z.numberFormat(l, e) + f);
                c.push(s({
                    chart: b,
                    name: g,
                    options: {},
    ...
    m(["fill", "stroke"], function(a) {
        HighchartsAdapter.addAnimSetter(a,
            function(b) {
                b.elem.attr(a, Za.prototype.tweenColors(V(b.start), V(b.end), b.pos))
            })
    });
    da(la.prototype, "getAxes", function(a) {
        var b = this.options.colorAxis;
        a.call(this);
        this.colorAxis = [];
        b && new Za(this, b)
    });
    da(Xa.prototype, "getAllItems", function(a) {
        var b = [],
            c = this.chart.colorAxis[0];
        c && (c.options.dataClasses ? b = b.concat(c.getDataClassLegendSymbols()) : b.push(c), m(c.series, function(a) {
    ...
    var Ha = {
        ...
        gb = document.documentElement.style.vectorEffect !== void 0;
    U.map = u(U.scatter, {
        allAreas: !0,
        animation: !1,
        nullColor: "#F8F8F8",
    ...
    B.map = aa(B.scatter, u(Ha, {
        ...
        getBox: function(a) {
            ...
            m(a || [], function(a) {
                if (a.path) {
                    if (typeof a.path === "string") a.path = z.splitPath(a.path);
                    var h = a.path || [],
                        i = h.length,
                        m = !1,
                        q = -b,
                        ...
                        u = a.properties;
                    if (!a._foundBox) {
                        for (; i--;) typeof h[i] === "number" && !isNaN(h[i]) && (m ? (q = Math.max(q, h[i]),
                            t = Math.min(t, h[i])) : (s = Math.max(s, h[i]), r = Math.min(r, h[i])), m = !m);
                        a._midX = t + (q - t) * (a.middleX || u && u["hc-middle-x"] || 0.5);
                        a._midY = r + (s - r) * (a.middleY || u && u["hc-middle-y"] || 0.5);
                        a._maxX = q;
                        a._minX = t;
                        a._maxY = s;
                        a._minY = r;
                        a.labelrank = o(a.labelrank, (q - t) * (s - r));
                        a._foundBox = !0
                    }
            ...
            } else this.maxX = this.minX = this.maxY = this.minY = q
        },
        getExtremes: function() {
        ...
        setData: function(a, b) {
            ...
            if (d) {
                if (d.type === "FeatureCollection") {
                    ...
                    d = z.geojson(d, this.type, this)
                }
                this.getBox(d);
                this.mapData = d;
                this.mapMap = {};
                for (j = 0; j < d.length; j++) h = d[j], i = h.properties, h._i = j, e[0] && i && i[e[0]] && (h[e[0]] = i[e[0]]), this.mapMap[h[e[0]]] = h;
                c.allAreas && (a = a || [], e[1] && m(a, function(a) {
                        g.push(a[e[1]])
                    }), g = "|" + g.join("|") +
                    "|", m(d, function(b) {
                        (!e[0] || g.indexOf("|" + b[e[0]] + "|") === -1) && a.push(u(b, {
                            value: null
                        }))
                    }))
            }
        ...
        translate: function() {
            ...
            m(a.data, function(e) {
                ...
                if (d) e.shapeType = "path", e.shapeArgs = {
                    ...
                    gb && (e.shapeArgs["vector-effect"] = "non-scaling-stroke")
            });
            a.translateColors()
        },
        drawPoints: function() {
            ...
            a.doFullTranslate() ? (e.hasRendered && a.pointAttrToOptions.fill === "color" && m(a.points, function(a) {
                a.graphic && a.graphic.attr("fill", a.color)
            }), gb || m(a.points, function(b) {
                b = b.pointAttr[""];
                b["stroke-width"] === a.pointAttr[""]["stroke-width"] && (b["stroke-width"] =
                    "inherit")
            }), a.group = a.transformGroup, B.column.prototype.drawPoints.apply(a), a.group = d, m(a.points, function(a) {
                a.graphic && (a.name && a.graphic.addClass("highcharts-name-" + a.name.replace(" ", "-").toLowerCase()), a.properties && a.properties["hc-key"] && a.graphic.addClass("highcharts-key-" + a.properties["hc-key"].toLowerCase()), gb || (a.graphic["stroke-widthSetter"] = T))
            }), this.baseTrans = {
            ...
            gb || a.group.element.setAttribute("stroke-width", a.options.borderWidth / (g || 1));
        ...
        b.prototype.hideOverlappingLabels =
            function(a) {
                ...
                for (d = 0; d < b; d++) {
                    i = a[d];
                    for (c = d + 1; c < b; ++c)
                        if (j = a[c], i && j && i.placed && j.placed && i.newOpacity !== 0 && j.newOpacity !== 0 && !(j.alignAttr.x > i.alignAttr.x + i.width || j.alignAttr.x + j.width < i.alignAttr.x || j.alignAttr.y > i.alignAttr.y + i.height || j.alignAttr.y + j.height < i.alignAttr.y))(i.labelrank < j.labelrank ? i : j).newOpacity = 0
                }
                for (d = 0; d < b; d++)
                    if (c = a[d]) {
    ...
    s(la.prototype, {
        renderMapNavigation: function() {
            ...
            if (o(b.enableButtons, b.enabled) && !a.renderer.forExport)
                for (d in c)
                    if (c.hasOwnProperty(d)) f = u(b.buttonOptions, c[d]), e = f.theme, e.style = u(f.theme.style, f.style), g = e.states, e = a.renderer.button(f.text, 0, 0, h, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" : "bottombutton").attr({
                        width: f.width,
                        height: f.height,
                        title: a.options.lang[d],
                        zIndex: 5
                    }).add(), e.handler = f.onclick, e.align(s(f, {
                        width: e.width,
                        height: 2 * e.height
                    }), null, f.alignTo)
        },
    ...
    da(la.prototype, "render", function(a) {
        var b = this,
            c = b.options.mapNavigation;
        b.renderMapNavigation();
        a.call(b);
        (o(c.enableDoubleClickZoom,
            c.enabled) || c.enableDoubleClickZoomTo) && M(b.container, "dblclick", function(a) {
            b.pointer.onContainerDblClick(a)
        });
        o(c.enableMouseWheelZoom, c.enabled) && M(b.container, document.onmousewheel === void 0 ? "DOMMouseScroll" : "mousewheel", function(a) {
    ...
    s(za.prototype, {
        onContainerDblClick: function(a) {
            var b = this.chart,
                a = this.normalize(a);
            b.options.mapNavigation.enableDoubleClickZoomTo ? b.pointer.inClass(a.target, "highcharts-tracker") && b.hoverPoint.zoomTo() : b.isInsidePlot(a.chartX -
                b.plotLeft, a.chartY - b.plotTop) && b.mapZoom(0.5, b.xAxis[0].toValue(a.chartX), b.yAxis[0].toValue(a.chartY), a.chartX, a.chartY)
        },
    ...
    da(za.prototype, "init", function(a, b, c) {
        a.call(this, b, c);
        if (o(c.mapNavigation.enableTouchZoom, c.mapNavigation.enabled)) this.pinchX =
            this.pinchHor = this.pinchY = this.pinchVert = this.hasZoom = !0
    });
    da(za.prototype, "pinchTranslate", function(a, b, c, d, e, f, g) {
    ...
    B.bubble = aa(B.scatter, {
        ...
        getRadii: function(a, b, c, d) {
            ...
            for (f = 0, e = h.length; f < e; f++) g = b - a, g = g > 0 ? (h[f] - a) / (b - a) : 0.5, j && g >= 0 && (g = Math.sqrt(g)), i.push(J.ceil(c +
                g * (d - c)) / 2);
            this.radii = i
        },
        animate: function(a) {
            var b = this.options.animation;
            if (!a) m(this.points, function(a) {
                var d = a.graphic,
                    a = a.shapeArgs;
        ...
        drawPoints: B.column.prototype.drawPoints,
    ...
    X.prototype.beforePadding = function() {
        var a = this,
            ...
            h = this.min,
            i = {},
            j = J.min(c.plotWidth, c.plotHeight),
            k = Number.MAX_VALUE,
            l = -Number.MAX_VALUE,
            n = this.max - h,
            p = b / n,
        ...
        m(this.series, function(b) {
            ...
            if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries))
                if (a.allowZoomOutside = !0, r.push(b), f) m(["minSize", "maxSize"], function(a) {
                    var b = d[a],
                        c = /%$/.test(b),
                        b = D(b);
                    i[a] = c ? j * b / 100 : b
                }), b.minPxSize = i.minSize, b = b.zData, b.length && (k = o(d.zMin, J.min(k, J.max(Ra(b), d.displayNegative === !1 ? d.zThreshold : -Number.MAX_VALUE))), l = o(d.zMax, J.max(l, Da(b))))
        });
        m(r, function(a) {
            var b = a[g],
                c = b.length,
            ...
            if (n >
                0)
                for (; c--;) typeof b[c] === "number" && (j = a.radii[c], d = Math.min((b[c] - h) * p - j, d), e = Math.max((b[c] - h) * p + j, e))
        });
        r.length && n > 0 && o(this.options.min, this.userMin) === q && o(this.options.max, this.userMax) === q && (e -= b, p *= (b + d - e) / b, this.min += d / p, this.max += e / p)
    };
    if (B.bubble) U.mapbubble = u(U.bubble, {
        animationLimit: 500,
        tooltip: {
            pointFormat: "{point.name}: {point.z}"
        }
    }), B.mapbubble = aa(B.bubble, {
        pointClass: aa(Z, {
            applyOptions: function(a, b) {
                var c;
                a.lat !== void 0 && a.lon !== void 0 ? (c = Z.prototype.applyOptions.call(this, a, b),
                    c = s(c, this.series.chart.fromLatLonToPoint(c))) : c = Ib.prototype.applyOptions.call(this, a, b);
                return c
            },
            ttBelow: !1
        }),
    ...
    la.prototype.transformFromLatLon = function(a, b) {
        if (window.proj4 === void 0) return ba(21), {
            x: 0,
            y: null
        };
        var c = window.proj4(b.crs, [a.lon, a.lat]),
            ...
            c =
            b.rotation ? [c[0] * d + c[1] * e, -c[0] * e + c[1] * d] : c;
        return {
    ...
    la.prototype.transformToLatLon = function(a, b) {
        if (window.proj4 === void 0) ba(21);
        else {
            var c = {
    ...
    la.prototype.fromPointToLatLon = function(a) {
        var b = this.mapTransforms,
            c;
        if (b) {
            for (c in b)
                if (b.hasOwnProperty(c) && b[c].hitZone && Bb({
                        x: a.x,
                        y: -a.y
    ...
    la.prototype.fromLatLonToPoint = function(a) {
        var b = this.mapTransforms,
            c, d;
        if (!b) return ba(22), {
            x: 0,
        ...
        for (c in b)
            if (b.hasOwnProperty(c) && b[c].hitZone && (d = this.transformFromLatLon(a, b[c]), Bb({
                    x: d.x,
                    y: -d.y
    ...
    z.geojson = function(a, b, c) {
        ...
        m(a.features, function(a) {
            ...
            e = [];
            b === "map" || b === "mapbubble" ? (i ===
                "Polygon" ? (m(c, f), e.push("Z")) : i === "MultiPolygon" && (m(c, function(a) {
                    m(a, f)
                }), e.push("Z")), e.length && (j = {
                    path: e
                })) : b === "mapline" ? (i === "LineString" ? f(c) : i === "MultiLineString" && m(c, f), e.length && (j = {
                path: e
    ...
    da(la.prototype, "showCredits", function(a, b) {
        if (I.credits.text === this.options.credits.text && this.mapCredits) b.text = this.mapCredits, b.href = null;
        a.call(this, b);
    ...
    z.maps = {};
    ia.prototype.symbols.topbutton = function(a, b, c, d, e) {
        return Cb(e, a, b, c, d, e.r, e.r, 0, 0)
    };
    ia.prototype.symbols.bottombutton = function(a, b, c, d, e) {
        return Cb(e, a, b, c, d, 0, 0, e.r, e.r)
    };
    Ma === Wa && m(["topbutton", "bottombutton"],
        function(a) {
            Wa.prototype.symbols[a] = ia.prototype.symbols[a]
        });
    z.Map = function(a, b) {
        var c = {
                endOnTick: !1,
    ...
    I.plotOptions.heatmap = u(I.plotOptions.scatter, {
        animation: !1,
        borderWidth: 0,
        nullColor: "#F8F8F8",
        dataLabels: {
    ...
    B.heatmap = aa(B.scatter, u(Ha, {
        ...
        getExtremesFromAll: !0,
        init: function() {
            B.scatter.prototype.init.apply(this, arguments);
    ...
    Ha = z.TrackerMixin = {
        drawTrackerPoint: function() {
            var a = this,
                ...
                f = function(a) {
                    ...
                    if (d !== q && d !== b.hoverPoint) d.onMouseOver(a)
                };
            m(a.points, function(a) {
        ...
        drawTrackerGraph: function() {
            var a = this,
                ...
                o = "rgba(192,192,192," + (ca ? 1.0E-4 : 0.002) + ")";
            if (e && !c)
    ...
    if (B.column) E.prototype.drawTracker = Ha.drawTrackerPoint;
    if (B.pie) B.pie.prototype.drawTracker = Ha.drawTrackerPoint;
    ...
    s(la.prototype, {
        ...
        zoom: function(a) {
            ...
            else if (!d && ea(e)) this.resetZoomButton = e.destroy();
            b && this.redraw(o(this.options.chart.animation, a && a.animation, this.pointCount <
                100))
        },
        pan: function(a, b) {
            var c = this,
            ...
            m(b === "xy" ? [1, 0] : [1], function(b) {
                var d = a[b ? "chartX" : "chartY"],
                    ...
                    i = i > d;
                if (h.series.length && (i || l > N(k.dataMin, k.min)) && (!i || j < v(k.dataMax, k.max))) h.setExtremes(l, j, !1, !1, {
                    trigger: "pan"
                }), e = !0;
    ...
    s(Z.prototype, {
        ...
        importEvents: function() {
            if (!this.hasImportedEvents) {
                var a = u(this.series.options.point, this.options).events,
                    b;
                this.events = a;
                for (b in a) M(this,
                    b, a[b]);
        ...
        setState: function(a, b) {
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    ...
                    o.attr(s({
                            fill: V(this.color || e.color).setOpacity(c.opacity).get()
                        },
    ...
    s(S.prototype, {
        ...
        setVisible: function(a, b) {
            var c = this,
                ...
                h = c.visible;
            f = (c.visible = a = c.userOptions.visible = a === q ? !h : a) ? "show" : "hide";
        ...
        select: function(a) {
            this.selected = a = a === q ? !this.selected : a;
